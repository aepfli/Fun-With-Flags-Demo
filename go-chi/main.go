// Package main is the entry point for the Fun With Flags Go demo. Step 3.2
// adds a goVersion-based targeting rule that is evaluated via a global
// evaluation context installed by the flagd setup package.
package main
