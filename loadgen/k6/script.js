...
// :8080 of whichever folder you're running. FLAGD_URL is flagd's eval
// endpoint on :8013 (the gRPC port also serves HTTP/JSON via gRPC-Gateway,
// so a plain curl-style POST works against the same port the SDK uses).
